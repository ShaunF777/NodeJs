...
fs.readFile('test-file.txt', () => {
  ...
  crypto.pbkdf2Sync('password', 'salt', 100000, 1024, 'sha512'); // will block because its synchronous
...
/*Blocks the entire execution and background workers could only be run after the blockage */
